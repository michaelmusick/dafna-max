...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 757.0, 542.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 756.0, 542.0, 96.0, 20.0 ],
					"style" : "",
					"text" : "off"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 772.0, 573.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 756.0, 588.0, 96.0, 20.0 ],
					"style" : "",
					"text" : "filter cutoff"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 770.0, 560.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 756.0, 573.0, 96.0, 20.0 ],
					"style" : "",
					"text" : "feedback"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 773.0, 546.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 756.0, 558.0, 96.0, 20.0 ],
					"style" : "",
					"text" : "delay"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 993.0, 281.0, 18.0, 66.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 731.9104, 542.0, 18.0, 66.0 ],
					"size" : 4,
					"style" : "",
					"value" : 3
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1051.0, 254.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 841.0, 594.0, 96.0, 20.0 ],
					"style" : "",
					"text" : "scaled for you!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1099.0, 481.5, 78.0, 35.0 ],
					"style" : "",
					"text" : "scale 0 127 40 10000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1069.5, 447.0, 78.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 993.0, 484.0, 78.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1054.0, 372.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 841.0, 564.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 993.0, 372.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1029.0, 406.0, 100.0, 22.0 ],
					"style" : "",
					"text" : "gate 3"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1054.0, 321.0, 40.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 841.0, 538.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "ctlin"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 971.0, 109.0, 160.0, 100.0 ],
					"presentation" : 1,
					"presentation_linecount" : 4,
					"presentation_rect" : [ 733.0, 66.0, 290.0, 60.0 ],
					"style" : "",
					"text" : "try sustained sounds (long), and also short sounds, hard attacks, short attacks, high pitch, low pitch and various combinations with different delay times and different amounts of feedback.."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 445.0, 77.0, 150.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 579.0, 32.0, 279.0, 20.0 ],
					"style" : "",
					"text" : "PLAY WITH ALL PARAMETERS.."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 15.0, 97.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "sel 32"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 65.0, 59.5, 22.0 ],
					"style" : "",
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 518.0, 142.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "0.8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 563.0, 576.0, 150.0, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 119.0, 381.0, 150.0, 33.0 ],
					"style" : "",
					"text" : "<==freeze (click or hit space bar)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 532.0, 575.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 82.0, 373.0, 31.0, 31.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 530.0, 602.0, 62.0, 22.0 ],
					"style" : "",
					"text" : "freeze $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 494.0, 293.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "50"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 498.0, 333.0, 152.0, 47.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 118.0, 343.0, 187.0, 33.0 ],
					"style" : "",
					"text" : "<=glide time to new delay (try long and short times..)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 492.0, 314.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 63.0, 340.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.0, 228.0, 68.0, 22.0 ],
					"style" : "",
					"text" : "pack 0. 50"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 301.0, 250.0, 38.0, 22.0 ],
					"style" : "",
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 23.0, 569.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "random 2000"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 118.0, 314.0, 213.0, 20.0 ],
					"style" : "",
					"text" : "<=send bang when over threshhold"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 26.0, 537.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 93.0, 313.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-57",
					"items" : [ "Built-in Output", ",", "HDMI", ",", "USBPre2", ",", "Pro Tools Aggregate I/O" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-36",
					"items" : [ "Built-in Microphone", ",", "Built-in Input", ",", "USBPre2", ",", "Pro Tools Aggregate I/O" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 306.0, 397.0, 300.0, 100.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 182.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 462.0, 435.0, 103.0, 23.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 424.0, 366.5, 44.0, 22.0 ],
					"style" : "",
					"text" : "10000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 302.0, 321.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 280.0, 281.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "tapout~ 2000"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -4.0, -3.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 68.843384, 12.384094, 219.0, 89.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 395.0, 285.093689, 219.0, 89.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 311.5, 314.0, 416.0, 314.0, 416.0, 174.0, 292.5, 174.0 ],
					"source" : [ "obj-13", 0 ]
				}
